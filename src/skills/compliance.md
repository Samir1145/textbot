---
name: compliance
description: Assist with privacy regulation compliance, DPA reviews, data subject request handling, and regulatory monitoring. Use when reviewing vendor DPAs, advising on GDPR/CCPA obligations, handling data subject requests, or assessing cross-border data transfer requirements.
---
...
- **Right to correct**: Consumers can request correction of inaccurate personal information (CPRA)
- **Right to limit use of sensitive personal information**: Consumers can limit use of sensitive PI (CPRA)
- **Non-discrimination**: Cannot discriminate against consumers who exercise their rights
- **Privacy notice**: Must provide at or before collection
- **Service provider agreements**: Contracts must restrict use of PI to the specified business purpose
...
- [ ] **Security measures**: Appropriate technical and organizational measures described (Article 32)
...
- [ ] **Security and breach assistance**: Assist with breach notification, DPIAs, and prior consultation
...
- [ ] **Breach notification**: Processor will notify controller without undue delay (ideally within 24-48 hours)
...
- [ ] **Supplementary measures**: Technical, organizational, or contractual measures to address gaps
- [ ] **UK addendum**: If UK personal data is in scope, UK International Data Transfer Addendum included

### Practical Considerations

- [ ] **Liability**: DPA liability provisions align with the main services agreement
...
1. **Identify the request type**: Access, rectification, erasure, restriction, portability, objection, opt-out
2. **Identify applicable regulation(s)**: Where is the data subject located?
3. **Verify identity**: Confirm the requester is who they claim to be
4. **Log the request**: Date received, type, requester identity, applicable regulation, response deadline, assigned handler
...
- Regulatory retention: Mandatory retention periods for financial records, employment records, etc.
...
- **Regulatory guidance**: New or updated guidance from supervisory authorities (ICO, CNIL, FTC, state AGs)
- **Enforcement actions**: Fines, orders, and settlements that signal regulatory priorities
- **Legislative changes**: New privacy laws, amendments, implementing regulations
- **Industry standards**: Updates to ISO 27001, SOC 2, NIST frameworks, sector-specific requirements
